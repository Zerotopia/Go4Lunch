...
public class DetailViewModel extends ViewModel {
    ...
    public final LiveData<Place> getPlaceObservable() {
        return mPlaceObservable;
    }

    public final LiveData<Bitmap> getPhotoObservable() {
        return mPhotoObservable;
    }
    ...
    public void updateCurrentRestaurant() {
        mCurrentRestaurantIdObservable.setValue(mCurrentRestaurantIdObservable.getValue());
    }

    public final LiveData<Boolean> getIsLike() {
        return mLikeObservable;
    }

    public final LiveData<Boolean> getIsLunch() {
        return mUserRestaurantObservable;
    }

    public final LiveData<List<User>> getUsersLunch() {
        return mUsersObservable;
    }

    public final LiveData<String> getCurrentRestaurantId() {
        return mCurrentRestaurantIdObservable;
    }

    public final LiveData<Integer> getRatioRestaurant() {
